...
export interface BuidlerFiSharesV1Interface extends utils.Interface {
  functions: {
...
export interface BuidlerFiSharesV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuidlerFiSharesV1Interface;
